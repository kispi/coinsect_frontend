...
const marketInfo = {
  ...
  crypto: params => $httpNoAuth.get('https://api.coinmarketcap.com/data-api/v3/cryptocurrency/listing', { params }),
  nasdaq: arrTickers => $http.get('market_info/nasdaq', { params: { query: (arrTickers || []).join(',') } }),
