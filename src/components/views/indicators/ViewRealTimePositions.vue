<template>
  <div
    ...
    <div class="description">
      <div class="m-b-8">* 운영자가 각 방송을 모니터링하며 입력하므로 대부분 실시간이지만, 미처 업데이트하지 못하고 잠들었을 수 있으므로 최신 포지션임을 보장할 수 없습니다. 업데이트된지 오래된 경우 신뢰하지 마십시오. 어떤 경우이든 재미로만 보시고, 호반꿀이든 호반반꿀이든 <b class="c-danger">절대로 타인의 매매를 참고하여 매매하지 마십시오</b>.</div>
      <div class="m-b-8">* 포지션 정보는 5분 간격으로 새로 가져오므로, 현재 방송으로 보고 있는 포지션과 다른 경우 새로고침을 해보십시오.</div>
      <div>* 포지션의 규모가 너무 작거나, 거미줄이 체결되는 상황등 포지션 변동이 극도로 잦은 경우 (정찰병같은) 모니터링 대상에서 제외됩니다.</div>
    </div>
    <RouterLink
      to="/"
      class="btn btn-dark">
