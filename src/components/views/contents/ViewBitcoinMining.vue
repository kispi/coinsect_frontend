  ...
  <div class="view-bitcoin-mining">
    ...
    <div
      ...
      <div class="description">
        ...
        4. 정확한 표현은 아니나, 대중적 이해의 수준에서는 보통 해시값 '맨 앞에 연속한 1의 개수' = '난이도' 정도로 설명하는 수준으로 족하다. (사실은 좀 더 복잡하다.)
      </div>
      <div class="f-12 m-t-8">참조: <a href="https://medium.com/dnext-post/blockchain-core-series-pow-61227506a8c7" target="_blank">블록체인 코어 시리즈: 작업증명(PoW)</a></div>
    </div>
