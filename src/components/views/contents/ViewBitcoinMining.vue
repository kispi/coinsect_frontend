  ...
  <div class="view-bitcoin-mining">
    ...
    <div
      ...
      <div
        ...
        4. 정확한 표현은 아니나, 대중적 이해의 수준에서는 보통 '해시값 맨 앞의 연속한 0의 개수' = '난이도' 정도로 설명하는 수준으로 족하다. (사실은 좀 더 복잡하다.)<br>
        5. 해시값은 64자리 16진수이므로, 난이도 1이 증가할 때마다 채굴에 소모되는 시간은 대략 평균적으로 16배가 증가한다고 생각할 수 있다.<br>
